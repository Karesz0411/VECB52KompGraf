...
public class VECB52_2dGraphics extends JFrame{
    ...
    VECB52_2dGraphics() {
        ...
        ImageIcon icon = new ImageIcon("C:\\MKgit\\VECB52KompGraf\\VECB52_hianypotlas\\VECB52_0509\\VECB52_2dGraphics\\src\\main\\java\\hu\\the\\vecb52\\vecb52_2dgraphics\\the.png");
        image = icon.getImage();
        ...
        panel = new JPanel() {
            ...
            protected void paintComponent(Graphics shapes) {
                ...
                g2d.setClip(new Ellipse2D.Float(20, 150, 400, 230));
                ...
                g2d.setClip(new Arc2D.Float(20, 150, 400, 230, 90, 180, Arc2D.OPEN));
                for (int i = 0; i < 400; i += 20) {
                    g2d.drawLine(20 + i, 150, 20 + i, 380);
                }
